...
if($method == 'POST')
{
	...
	if ($com == 'locality')
	{
		...
		$json_url = "http://74.201.240.43:8000/ChatBot/Sample_chatbot/Dyn_xsjs_chatbot.xsjs?ENT_OP='0'&ENT_LOC='LOCATION'&ENT_ROOM='BEDROOM'&ENT_BUILT='0'&ENT_SAL='0'&COMMAND=$com&AREA_NUM=0&ROOMS=3&BUILT_YEAR=0&LOWSAL=0&HIGHSAL=0";
